...
import (
	...
	userv1alpha1 "github.com/RiRa12621/openshift-lab-operator/pkg/apis/user/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &userv1alpha1.User{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *userv1alpha1.User) *corev1.Pod {
